...
Item {
  ...
  readonly property int fieldFontSize: Math.round(Style.font.heading * 0.95)
  ...
  Rectangle {
    ...
    // 12-Hour Live Clock and Date Header
    Column {
      id: clockColumn
      ...
      Text {
        ...
        font.family: Style.font.family
        font.pixelSize: Math.round(Style.font.baseSize * 4.8)
      ...
      Text {
        ...
        font.family: Style.font.family
        font.pixelSize: Math.round(Style.font.baseSize * 1.35)
      }
