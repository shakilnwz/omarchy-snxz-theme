...
Item {
  ...
  readonly property int cornerRadius: Math.max(10, Style.cornerRadius)
  ...
  property int cardWidth: Math.min(root.dmenuActive ? Style.space(Math.max(root.dmenuWidth, 600)) : Style.space(600), panel.width - Style.gapsOut * 2)
